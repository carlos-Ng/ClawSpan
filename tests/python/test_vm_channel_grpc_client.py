...
import vm_channel_grpc_client as client_module  # noqa: E402
...
class VmGrpcClientTest(unittest.TestCase):
	def setUp(self) -> None:
		self.stub = _DummyStub()
		self.channel = _DummyChannel()
		self.grpc_stub_factory = lambda _channel: self.stub
		self.client = client_module.VmGrpcClient()
		self.client._tunnel = _DummyTunnel()
		self.client._pb2 = _DummyPb2
		self.client._pb2_grpc = SimpleNamespace(VmChannelServiceStub=self.grpc_stub_factory)
